...
4. Write a short practical health tip for EVERY item (one sentence) in all three languages:
   ...
   - ALL HIGH RISK CASE: If all top 3 items in a category are High risk, recommend a healthier alternative.
...
{
  "Appetizer": [{"f":"食物名称","sugar":数字,"salt":数字,"fat":数字,"risk":"Low"|"Medium"|"High","tip":{"en":"...","ms":"...","zh":"..."},"best_reason":{"en":"...","ms":"...","zh":"..."}}],
  "Main Dish": [],
  "Dessert": [],
  "Drinks": [],
  "uniqueFoodCount": 数字
