...
const content = {
  en: {
    page_title: "Malaysia's Three Highs Statistics",
    page_subtitle: "Diabetes is Malaysia’s health challenge. See how it links to high blood pressure and cholesterol, and how small changes help.",
    summary_why: "Why this matters for you",
    summary_body: "Malaysia has one of the highest diabetes rates in Asia. It rarely comes alone, high blood pressure and cholesterol often follow. Scroll down to understand the picture, then take one small step today.",
    ...
    stats3:[
      { value: "2 in 5", label: "Elderly have diabetes" },
      { value: "3 in 4", label: "Elderly have high blood pressure" },
      { value: "3 in 4", label: "Elderly have high cholesterol" },
    ],
    ...
    map_subtitle: "Select your state on the map to check local health trends and see how your community is doing.",
    ...
    ethnicity_subtitle: "See how the \"three highs\" affect different communities so we can better protect and care for our elders",
    ...
    disclaimer_text: "These numbers represent real people who deserve support and accurate information. This is why understanding \"three highs\" matters.",
    good_news_cta: "See foods that help manage all three →",
  },
  ms: {
    page_title: "Statistik Penyakit Tiga Serangkai Malaysia",
    page_subtitle: "Diabetes merupakan cabaran kesihatan di Malaysia. Lihat bagaimana ia berkaitan dengan tekanan darah tinggi dan kolesterol, dan bagaimana perubahan kecil membantu.",
    summary_why: "Mengapa ini penting untuk anda",
    summary_body: "Malaysia mempunyai salah satu kadar diabetes tertinggi di Asia. Dia jarang berlaku bersendirian, tekanan darah tinggi dan kolesterol sering mengikuti. Tatal ke bawah untuk memahami gambarannya, kemudian ambil satu langkah kecil hari ini.",
    summary_cta1: "Semak pilihan makanan anda",
    summary_cta2: "Ketahui tentang penyakit tiga serangkai",
    stat_nudge: [
    ...
    stats_title2: "Penyakit Tiga Serangkai di Malaysia",
    stats: [
      { value: "1 daripada 5", label: "Orang dewasa Malaysia menghidap diabetes", image: "/images/1-in-5.png" },
      { value: "2 daripada 5", label: "Warga emas berusia 60+ terjejas", icon: TrendingUp },
      { value: "4.75 Juta", label: "Orang hidup dengan diabetes", icon: Heart },
    ],
    stats2: [
      { value: "3 daripada 4", label: "Warga emas mempunyai hipertensi atau hiperlipidemia (kolesterol tinggi)", icon: HeartPulse },
      { value: "68%", label: "Warga emas yang hidup dengan dua daripada tiga penyakit tiga serangkai", icon: CircleAlert },
      { value: "30%", label: "Warga emas yang mempunyai ketiga-tiga penyakit tiga serangkai", icon: TriangleAlert },
    ],
    stats3:[
      { value: "2 daripada 5", label: "Warga emas menghidap diabetes" },
      { value: "3 daripada 4", label: "Warga emas mempunyai tekanan darah tinggi" },
      { value: "3 daripada 4", label: "Warga emas menghidap kolesterol tinggi" },
    ],
    tab_prevalence: "Prevalens Diabetes",
    tab_trends: "Aliran Penyakit Tiga Serangkai",
    ...
    map_subtitle: "Pilih negeri anda pada peta untuk menyemak trend kesihatan tempatan dan melihat prestasi komuniti anda.",
    trends_title: "Aliran Penyakit Tiga Serangkai di Malaysia",
    ...
    ethnicity_subtitle: "Lihat bagaimana penyakit tiga serangkai mempengaruhi komuniti yang berbeza supaya kita dapat melindungi dan menjaga warga emas kita dengan lebih baik.",
    ...
    disclaimer_text: "Nombor-nombor ini mewakili orang sebenar yang memerlukan sokongan dan maklumat yang tepat. Inilah sebabnya memahami penyakit tiga serangkai penting.",
    good_news_cta: "Lihat makanan yang membantu mengurus ketiga-tiga Penyakit Tiga Serangkai →",
  },
  zh: {
    page_title: "马来西亚三高统计数据",
    page_subtitle: "糖尿病是马来西亚面临的健康挑战。了解它与高血压和胆固醇的关联，以及小小的改变如何带来大大的不同。",
    summary_why: "为什么这对您很重要",
    summary_body: "马来西亚是亚洲糖尿病发病率最高的国家之一。它很少单独出现，高血压和高胆固醇往往相伴而来。往下浏览来了解全貌，从今天开始迈出一小步。",
    ...
    stats3:[
      { value: "五分之二", label: "60岁以上老年人患有糖尿病" },
      { value: "四分之三", label: "60岁以上老年人患有高血压" },
      { value: "四分之三", label: "60岁以上老年人患有高胆固醇" },
    ],
    tab_prevalence: "糖尿病患病率",
    tab_trends: "三高趋势",
    tab_hints: "💡 提示：使用下面的按钮在不同的数据视图之间切换。",
    map_title: "探索您所在地区的情况",
    map_subtitle: "在地图上选择您所在的州，查看当地的健康趋势，了解您所在社区的情况。",
    ...
    ethnicity_subtitle1: "来自最新包含“三高”数据的马来西亚国家健康与疾病调查（NHMS）的数据, 2023年",
    ethnicity_subtitle: "了解“三高”如何影响不同的社区，以便我们更好地保护和照顾我们的长者。",
    ...
    disclaimer_text: "这些数字代表真实的人，他们需要支持和准确的信息。这就是为什么了解“三高”很重要。",
...
const ETHNICITY_EXPLANATIONS: Record<string, EthnicityExplanation> = {
  ...
  "Bumiputera Sarawak": {
    ...
    actions: {
      ...
      ms: [
        "Periksa tekanan darah anda secara kerap — hipertensi 41% bermakna hampir 1 daripada 2 orang dewasa mungkin terjejas, selalunya tanpa mengetahuinya.",
...
function SummaryBanner({ t }: { t: typeof content.en }) {
  const stats = [
    { value: t.stats3[0].value, label: t.stats3[0].label },
    { value: t.stats3[1].value, label: t.stats3[1].label },
    { value: t.stats3[2].value, label: t.stats3[2].label },
  ]
  return (
