...
const content = {
  ...
  ms: {
    page_title: "Penyakit Tiga Serangkai: Bermula dengan Diabetes",
    ...
    body_map_title: "Bagaimana Penyakit Tiga Serangkai mempengaruhi badan anda",
    edu_title: "Fahami Diabetes dan Rakan-rakannya (Penyakit Tiga Serangkai)",
  ...
  zh: {
    ...
    page_subtitle: "高血糖、 高血压和高胆固醇是马来西亚最大的健康隐形杀手。了解它们是迈向更健康生活的第一步。",
    stats_title: "马来西亚的糖尿病",
    edu_title: "了解糖尿病和它的伙伴（三高）",
    education: "教育",
    explore: "探索",
    debunk: "揭穿谬误",
